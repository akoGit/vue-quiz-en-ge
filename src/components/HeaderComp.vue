...
<template>
  <header>
    ...
    <div class="wrap__btns">
      ...
      <button @click="toggleDark()" class="btn theme" title="Change Theme">
        <svg
          width="15"
          height="15"
          viewBox="0 0 15 15"
      ...
      <button @click="isAlertOpen = true" class="btn reset" title='Restart questions'>
